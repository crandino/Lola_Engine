...
{
	DEBUG("Creating 3D Physics simulation");
	bool ret = true;
...
{
	DEBUG("Creating Physics environment");
...
{
	DEBUG("Destroying 3D Physics simulation");
...
// ---------------------------------------------------------
void ModulePhysics3D::AddConstraintP2P(PhysBody3D& bodyA, PhysBody3D& bodyB, const math::vec& anchorA, const math::vec& anchorB)
{
...
void ModulePhysics3D::AddConstraintHinge(PhysBody3D& bodyA, PhysBody3D& bodyB, const math::vec& anchorA, const math::vec& anchorB, const math::vec& axisA, const math::vec& axisB, bool disable_collision)
{
...
{
	DEBUG("Bullet warning: %s", warningString);
}

void DebugDrawer::draw3dText(const btVector3& location, const char* textString)
{
	DEBUG("Bullet draw text: %s", textString);
}
